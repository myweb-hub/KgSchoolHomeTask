//Here is a code that creates an array of persons. Every function is meant to output its number. But there’s something wrong in the code
...
//Why do all of the units return the same value? Try to fix the code so that it works in the correct way.